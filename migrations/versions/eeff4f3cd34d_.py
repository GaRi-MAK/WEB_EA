...
Revision ID: eeff4f3cd34d
Revises: 
Create Date: 2020-04-27 19:57:25.868653
...
def upgrade():
    ...
    sa.Column('even', sa.String(length=500), nullable=True),
    ...
    op.create_table('info_editions_desc',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(length=100), nullable=True),
    sa.Column('content', sa.String(length=500), nullable=True),
    ...
    op.create_table('why_sql_content',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(length=100), nullable=True),
    sa.Column('content', sa.String(length=1000), nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('why_sql_content')
    op.drop_table('service_type')
    op.drop_index(op.f('ix_post_timestamp'), table_name='post')
    op.drop_table('post')
    op.drop_table('info_editions_desc')
